...
CREATE TABLE `users` (
  ...
  `skey` varchar(255) DEFAULT NULL COMMENT 'Surrogate key',
  `wechat_user_id` varchar(255) DEFAULT NULL COMMENT 'The primary key from WeChat side to identify an user',
...
--
-- Dumping routines for database 'jiayuan_dental'
--
